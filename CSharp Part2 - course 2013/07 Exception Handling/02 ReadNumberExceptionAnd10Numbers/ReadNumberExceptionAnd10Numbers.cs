...
ОБЯСНЕНИЕ: Задача с малко...дървено формулирано условие, от което в първия момент човек не може да се ориентира какво точно се изисква от него.
 Ето как аз успях да си го разкодирам и обясна: При стартирането на козолата, трябва ръчно да задатете долна и горна граница на някакъв интервал от числа. След което
