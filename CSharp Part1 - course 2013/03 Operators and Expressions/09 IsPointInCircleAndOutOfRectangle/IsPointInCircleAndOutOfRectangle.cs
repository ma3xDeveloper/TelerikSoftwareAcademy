...
ОБЯСНЕНИЕ: В тази задача трябва да проверим дали координатите x и y се намират едновременно в дадената окръжност и същевременно извън дадения правоъгълник. 
